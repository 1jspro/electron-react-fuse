...
import { saveExpenditure, removeExpenditure } from '../store/expenditureSlice';
...
function PageHeader(props) {
  ...
  function handleRemoveExpenditure() {
    dispatch(removeExpenditure()).then(() => {
      navigate('/apps/expenditure');
    });
  }
      ...
      <div className="flex flex-col items-start max-w-full min-w-0">
        ...
        >
          ...
          >
            ...
            <span className="hidden sm:flex mx-4 font-medium">Expenditures</span>
          </Typography>
        </motion.div>
