...
function Category(props) {
  ...
  const category = useSelector(({ expenditureCategoriesApp }) => expenditureCategoriesApp.category);
  ...
  function handleSaveCategory() {
    dispatch(saveCategory(getValues())).then((action) => {
      ...
      navigate('/apps/expenditure-categories');
    });
  }
    ...
    return (
      ...
      >
        ...
        <Button
          ...
          component={Link}
          variant="outlined"
          to="/apps/expenditure-categories"
          color="inherit"
        >
          Go to Category Page
        </Button>
...
export default withReducer('expenditureCategoriesApp', reducer)(Category);
