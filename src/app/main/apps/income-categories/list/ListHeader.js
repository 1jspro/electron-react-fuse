...
function ListHeader(props) {
  ...
  function handleExcelExport() {
    dispatch(getAllCategories()).then((action) => {
      ...
      exportFromJSON({ data: listItems, fileName: 'Income-Categories', exportType: 'xls' });
    });
  }
  ...
  function handleCSVExport() {
    dispatch(getAllCategories()).then((action) => {
      ...
      exportFromJSON({ data: listItems, fileName: 'Income-Categories', exportType: 'csv' });
    });
  }
  ...
  return (
    <div className="flex flex-1 w-full items-center justify-between">
      ...
      >
        {permissions.indexOf("income-categories:create") > -1 && <Button
          component={Link}
          to="/apps/income-categories/new"
