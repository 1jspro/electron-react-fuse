...
function Category(props) {
  ...
  const category = useSelector(({ assetCategoriesApp }) => assetCategoriesApp.category);
  ...
  function handleSaveCategory() {
    dispatch(saveCategory(getValues())).then((action) => {
      ...
      navigate('/apps/asset-categories');
    });
  }
...
export default withReducer('assetCategoriesApp', reducer)(Category);
