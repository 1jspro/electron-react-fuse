...
function ListHeader(props) {
  ...
  function handleExcelExport() {
    dispatch(getAllCategories()).then((action) => {
      ...
      exportFromJSON({ data: listItems, fileName: 'Asset-Categories', exportType: 'xls' });
    });
  }
  ...
  function handleCSVExport() {
    dispatch(getAllCategories()).then((action) => {
      ...
      exportFromJSON({ data: listItems, fileName: 'Asset-Categories', exportType: 'csv' });
    });
  }
  ...
  return (
    <div className="flex flex-1 w-full items-center justify-between">
      ...
      >
        {permissions.indexOf("asset-categories:create") > -1 && <Button
          component={Link}
          to="/apps/asset-categories/new"
